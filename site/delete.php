...
<div class="card">
	<div class="card-header">
		<h4><span class='d-inline-block bg-info-sql text-white px-2 py-1'> 7 </span> DELETE</h4>
	</div>
...
<div class="mb-3">
		<span class='d-inline-block bg-info-sql-2 text-white px-2 py-1'>a-1</span> <strong>Syntaxe de base pour une suppression</strong> </br>
	
<div class="accordion accordion-flush" id="accordionFlushExample">
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
        La syntaxe de base pour supprimer des données d'une table est la suivante :
      </button>
    </h2>
...
<ul>
<li>"nom_de_la_table" est le nom de la table à partir de laquelle vous souhaitez supprimer des données.</li>
<li>"condition" est une clause qui spécifie les lignes à supprimer. Si vous omettez la clause WHERE, toutes les lignes de la table seront supprimées</li>
</ul>
	<div class="row">
		  <p id="data1" >
         Analyser et supprimer la donnéee ...
		 </p>
        </div>
         ...
         <div class="col-md-6 mb-3" style="height:150px"> 
		  ...
		  <div class="col-md-6 mb-3 " >		
			...
			<?php if(isset($_POST['execute_req1'])){
									$resus = $films-> delete_d($_POST['req_sql1'],'delete','data1');
					}
					?>			
			</div>
		</div>
...
<?php 
echo $resus;
$affichage = $films ->affich_resu($resus);?>
